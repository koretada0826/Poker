...
const ENTRIES: Entry[] = [
  ...
  {
    rank: 4, ja: 'スリーカード', en: 'Three of a Kind',
  ...
  {
    rank: 8, ja: 'フォーカード', en: 'Four of a Kind',
  ...
  {
    rank: 9, ja: 'ストレートフラッシュ', en: 'Straight Flush',
  ...
  {
    rank: 10, ja: 'ロイヤルフラッシュ', en: 'Royal Flush',
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <div className="mt-6 text-center text-xs text-white/60 leading-relaxed">
        役は「下から順番に」覚えるのがコツ。<br />
        初心者がよく出会うのは ハイカード/ワンペア/ツーペア が中心です。
      </div>
